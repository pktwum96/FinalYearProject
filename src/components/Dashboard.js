...
class Dashboard extends Component {
  ...
  render() {
    return (
      <div>
        <div className={this.state.active ? "d-flex toggled" : "d-flex"} id="wrapper" >
          ...
          <div id="page-content-wrapper">
            ...
            <nav className="navbar navbar-expand-lg navbar-light bg-light border-bottom">
              ...
              <div id="content">
                <button type="button" id="sidebarCollapse" className="navbar-btn" onClick={this.changeClass.bind(this)}>
                  <span></span>
                  <span></span>
                  <span></span>
                </button>
